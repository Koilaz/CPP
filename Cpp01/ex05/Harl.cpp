#include "Harl.hpp"
	...
	{
		std::cout<< "Warning\nOn est en 1955 les gars, faut se reveiller hein. Les anes partout,\n les Djellabas, l écriture illisible, ça va hein. S agirait de grandir, s agirait de grandir…"<<std::endl;
	}
